...
dxl_write_word(12, MOVING_SPEED, 2*VEL_ANDAR*0.872);
dxl_write_word(15, MOVING_SPEED, 2*VEL_ANDAR);
dxl_write_word(16, MOVING_SPEED, 2*VEL_ANDAR);
dxl_write_word(17, MOVING_SPEED, 2*VEL_ANDAR*0.345);
dxl_write_word(18, MOVING_SPEED, 2*VEL_ANDAR*0.109);
dxl_write_word(19, MOVING_SPEED, 2*VEL_ANDAR*0.4);
dxl_write_word(20, MOVING_SPEED, 2*VEL_ANDAR*0.364);
dxl_write_word(22, MOVING_SPEED, 2*VEL_ANDAR*0.6);



//dxl_write_word(16, MOVING_SPEED, VEL_ANDAR*0.139);

dxl_write_word(20, P_GOAL_POSITION_L, 510-38);
dxl_write_word(18, P_GOAL_POSITION_L, 512+57);
dxl_write_word(22, P_GOAL_POSITION_L, 467-10);//27
...
dxl_write_word(17, P_GOAL_POSITION_L, 601-10);

dxl_write_word(16, P_GOAL_POSITION_L, 562+8);
dxl_write_word(14, P_GOAL_POSITION_L, 510+15);
...
dxl_write_word(12, MOVING_SPEED, 3*VEL_ANDAR*0.2);
dxl_write_word(16, MOVING_SPEED, 3*VEL_ANDAR*0.8);
...
dxl_write_word(18, P_GOAL_POSITION_L, 512);
dxl_write_word(22, P_GOAL_POSITION_L, 467-9);
espera_mov();
