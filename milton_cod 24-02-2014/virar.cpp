...
#define TYPE_FUNCTION *(mem+1)

void virar(int passos)
{
while(TYPE_FUNCTION == 3)
{
...
dxl_write_word(21, MOVING_SPEED, 2*VEL_ANDAR*2);
dxl_write_word(22, MOVING_SPEED, 2*VEL_ANDAR);
dxl_write_word(11, MOVING_SPEED, 2*VEL_ANDAR);
//------------- levanta perna dir -----------------------------------------------
...
short int servo21 = dxl_read_word(21, P_PRESENT_POSITION_L);
...
dxl_write_word(19, P_GOAL_POSITION_L, 512+15);
/**/
}
}
TYPE_FUNCTION = 0;  //Apaga valores residuais
}
